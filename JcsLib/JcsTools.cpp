...
extern "C"
{
    ...
    {
        // define static.
        byte* JcsTools::s_pJcsKey = nullptr;
        char* JcsTools::s_pJcsUniKey = nullptr;
        uint32 JcsTools::s_keyLength = 0;
        JCS_StringBuilder JcsTools::s_stringBuilder;

        // create the constant key value.
        uint32 JcsTools::s_checksumXorTable[CHECK_KEYS]
        {
        ...
        void JcsTools::CreateJcsKey(const JcsVersion gameVersion)
        {
            int32 keyLength;

            switch (gameVersion)
            {
            case JcsVersion::JCS_v01:
            {
                keyLength = JcsKey::jcs_key_file_v01_num;
                s_pJcsKey = JcsKey::jcs_key_file_v01;
            } break;
            case JcsVersion::JCS_v02:
            {
                keyLength = JcsKey::jcs_key_file_v02_num;
                s_pJcsKey = JcsKey::jcs_key_file_v02;
            } break;
            default:
            {
                if (s_keyLength == 0)
                    MessageBox(nullptr, L"", L"JcsTools", NULL);
            } break;
            }

            s_keyLength = keyLength;


            // TODO(JenChieh): This will crash...
            /*for (int i = 0; i < s_keyLength; ++i)
            s_pJcsUniKey[i] = (char)((s_pJcsKey[(i * 2) + 1] << 8) + s_pJcsKey[i * 2]);*/
        }

        // 
        wchar_t* JcsTools::DecryptNonUnicodeString(wchar_t stringToDecrypt[])
        {
            return nullptr;
        }

        // 
        wchar_t* JcsTools::DecryptString(wchar_t stringToDecrypt[])
        {
            return nullptr;
        }

        // 
        void JcsTools::DelDir(wchar_t* path)
        {

        }

        // 
        uint32 JcsTools::GetChecksum(JCS_BinaryReader rdr, int32 length, uint32 start)
        {
            return 0;
        }
        ...
        // 
        wchar_t* JcsTools::ReadNullTerminatedString(JCS_BinaryReader& reader)
        {
            // Clear before use.
            ...
            while (true)
            {
                num = reader.ReadByte8();
                if (num == 0)
                    break;

                s_stringBuilder.Append(num);
            }

            return s_stringBuilder.ToString();
        }
        // 
        int32 JcsTools::GetCompressedIntLength(int32 i)
        {
            return 0;
        }
        // 
        int32 JcsTools::GetEncodedStringLength(wchar_t* ws)
        {
            return 0;
        }
        // 
        int32 JcsTools::ReadCompressedInt(JCS_BinaryReader& reader)
        {
            return 0;
        }
        // 
        wchar_t* JcsTools::ReadDecodedString(JCS_BinaryReader& reader)
        {
            return nullptr;
        }
        // 
        wchar_t* JcsTools::ReadDecodedStringAtOffset(JCS_BinaryReader& reader, long32 offset)
        {
            return nullptr;
        }
        // 
        wchar_t* JcsTools::ReadDecodedStringAtOffsetAndReset(JCS_BinaryReader& reader, long32 offset)
        {
            return nullptr;
        }
        // 
        wchar_t* JcsTools::ReadDecodedStringAtOffsetAndReset(JCS_BinaryReader& reader, long32 offset, bool flag)
        {
            return nullptr;
        }
#else
        ...
        // 
        char* JcsTools::ReadNullTerminatedString(JCS_BinaryReader& reader)
        {
            // Clear before use.
            s_stringBuilder.Clear();
        ...
        // 
        int32 JcsTools::GetEncodedStringLength(char* ws)
        {
            return 0;
        }
        // 
        ...
        // 
        char* JcsTools::ReadDecodedString(JCS_BinaryReader& reader)
        {
            return nullptr;
        }
        // 
        char* JcsTools::ReadDecodedStringAtOffset(JCS_BinaryReader& reader, long32 offset)
        {
            return nullptr;
        }
        // 
        char* JcsTools::ReadDecodedStringAtOffsetAndReset(JCS_BinaryReader& reader, long32 offset)
        {
            return nullptr;
        }
        // 
        char* JcsTools::ReadDecodedStringAtOffsetAndReset(JCS_BinaryReader& reader, long32 offset, bool flag)
        {
            return nullptr;
        }
#endif // _UNICODE
        ...
        // 
        void JcsTools::WriteCompressedInt()
        {

        }

        // 
        void JcsTools::WriteEncodedString(JCS_BinaryWriter& writer)
        {

        }

        // 
        void JcsTools::WriteNullTerminatedString(JCS_BinaryWriter& writer)
        {
